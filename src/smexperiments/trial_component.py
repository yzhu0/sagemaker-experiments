...
class TrialComponent(_base_types.Record):
    ...
    def delete(self, disassociate=None):
        ...
        Args:
            disassociate (boolean): Indicates whether to disassociate the trial component with the trials before
            deletion. If set to true, disassociate the trial component with associated trials first, then delete
             the trial component. If it's not set or set to false, it will delete the trial component directory
